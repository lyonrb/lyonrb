= Lyon.Rb (http://www.lyonrb.fr)

== Qui sommes-nous?

Amateurs, professionels ou retraités passionnés par le langage Ruby, le framework Rails et le web en général.

== Que faisons-nous

1. Des apéros (lightning talks, discussions ouvertes),
2. Organisation du RubyCamp Lyon,
...
2. S'organiser lors des événements et être représenté moralement dans la communauté RubyFrance;
...
* Cloud Computing (Heroku, Engine Yard, Google App Engine)


== Repository Github de Lyon.rb
